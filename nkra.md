...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: поскоьку в одном документе слово "подыми" может встрчаться несколько раз.
```
### 2. IPM
